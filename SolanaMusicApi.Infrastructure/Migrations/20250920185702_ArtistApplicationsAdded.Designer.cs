...
namespace SolanaMusicApi.Infrastructure.Migrations
{
    ...
    [Migration("20250920185702_ArtistApplicationsAdded")]
    partial class ArtistApplicationsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolanaMusicApi.Domain.Entities.Performer.ArtistApplication", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SolanaMusicApi.Domain.Entities.Nft.LikedNft", b =>
                {
                    ...
                    b.HasOne("SolanaMusicApi.Domain.Entities.Nft.Nft", "Nft")
                        .WithMany("LikedNfts")
                        .HasForeignKey("NftId");
            ...
            modelBuilder.Entity("SolanaMusicApi.Domain.Entities.Performer.ArtistApplication", b =>
                {
                    b.HasOne("SolanaMusicApi.Domain.Entities.User.ApplicationUser", "Reviewer")
                        .WithMany("ReviewedApplications")
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SolanaMusicApi.Domain.Entities.User.ApplicationUser", "User")
                        .WithOne("ArtistApplication")
                        .HasForeignKey("SolanaMusicApi.Domain.Entities.Performer.ArtistApplication", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolanaMusicApi.Domain.Entities.User.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("ArtistApplication");
